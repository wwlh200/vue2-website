...
export default {
  ...
  methods: {
    ...
    getTableData() {
      ...
      fetch(`http://127.0.0.1:3000/api/product/search?type=${this.value}`, {
          method: 'GET',
          headers: {
    ...
    updTableData(data, action) {
      ...
      if (action == 'A') {
        url = 'http://127.0.0.1:3000/api/product/add';
        reqData = data;
        params = {
          method: 'POST',
          headers: {
        ...
        url = 'http://127.0.0.1:3000/api/product/update';
        reqData = data;
        params = {
          method: 'POST',
          headers: {
        ...
        url = `http://127.0.0.1:3000/api/product/del?model=${data.model}`;
        params = {
          method: 'GET',
          headers: {
            "Content-Type": "application/json"
